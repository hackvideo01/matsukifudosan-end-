...
{
    public class ConstructionFixsViewModel : BaseViewModel
    {
        ...
        public ConstructionFixsViewModel()
        {
            ...
            }, (p) =>
            {
                ...
                var AddConstruction = DataProvider.Ins.DB.ConstructionDB.Where(hno => hno.ConstructionId == constructId).SingleOrDefault();
                AddConstruction.CustomerNo = CustomerNo;
                AddConstruction.CustomerName = CustomerName;
                AddConstruction.HouseNo = HouseNo;
                AddConstruction.HouseName = HouseName;
                AddConstruction.MoneyAmount = MoneyAmount;
                AddConstruction.ConstructionDetails = ConstructionDetails;
                AddConstruction.Date = Date;
                DataProvider.Ins.DB.SaveChanges();
                MessageBox.Show("工事台帳の内容が修正しました。", "修正", MessageBoxButton.OK, MessageBoxImage.Information);
            });
        }
        private void reload()
        {
